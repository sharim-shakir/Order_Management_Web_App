...
[
    ...
    'active' => Yii::$app->controller->module->id === 'order', // Highlight if the current module is 'order'

    'items' => [
        [
            'label' => Yii::t('backend', 'Items'), // Submenu label
            'url' => ['/item/index'], // URL to the items page
            'icon' => FAR::icon('circle', ['class' => ['nav-icon']]), // Icon for items
            'active' => Yii::$app->controller->id === 'item', // Highlight if the current controller is 'item'
        ],
        [
            'label' => Yii::t('backend', 'Categories'), // Submenu label
            'url' => ['/category/index'], // URL to the categories page
            'icon' => FAR::icon('circle', ['class' => ['nav-icon']]), // Icon for categories
            'active' => Yii::$app->controller->id === 'category', // Highlight if the current controller is 'category'
        ],
        [
            'label' => Yii::t('backend', 'Orders'), // Submenu label
            'url' => ['/order/index'], // URL to the categories page
            'icon' => FAR::icon('circle', ['class' => ['nav-icon']]), // Icon for categories
            'active' => Yii::$app->controller->id === 'category', // Highlight if the current controller is 'category'
        ],
        [
            'label' => Yii::t('backend', 'Order Items'), // Submenu label
            'url' => ['/orderitem/index'], // URL to the categories page
            'icon' => FAR::icon('circle', ['class' => ['nav-icon']]), // Icon for categories
            'active' => Yii::$app->controller->id === 'category', // Highlight if the current controller is 'category'
        ],
        [
            'label' => Yii::t('backend', 'Stock'), // Submenu label
            'url' => ['/stock/index'], // URL to the categories page
            'icon' => FAR::icon('circle', ['class' => ['nav-icon']]), // Icon for categories
            'active' => Yii::$app->controller->id === 'category', // Highlight if the current controller is 'category'
        ],
    ],
